...
export type CareersQueryVariables = Exact<{ [key: string]: never }>
  ...
  mainThumbnail: {
    ...
    projectThumbnail: Array<{
      ...
      thumbnail: {
        ...
        placeholder: string
        alt: string
        source: { __typename?: 'UploadFile'; url: string } | null
      } | null
    } | null> | null
  } | null
}

export type OutsourcingsQueryVariables = Exact<{ [key: string]: never }>

export type OutsourcingsQuery = {
  __typename?: 'Query'
  outsourcings: Array<{
    __typename?: 'Outsourcing'
    title: string
...
export type ProjectDetailQuery = {
  ...
  project: {
    ...
    startDate: string
    endDate: string
    work: { __typename?: 'Work'; type: Enum_Work_Type; value: string | null } | null
    mainCoverImage: {
      __typename?: 'ComponentCommonImage'
      alt: string
      placeholder: string
    ...
    projectDetails: Array<{
      ...
      content: Array<
        | {
            ...
            alt: string
            placeholder: string
            source: { __typename?: 'UploadFile'; width: number | null; height: number | null; url: string } | null
          }
        | { __typename: 'ComponentProjectExplanation'; description: string; isRight: boolean | null }
        | null
      > | null
    } | null> | null
  } | null
...
export type ProjectMoveQueryVariables = Exact<{
  id: Scalars['ID']
}>

export type ProjectMoveQuery = {
  __typename?: 'Query'
  next: Array<{ __typename?: 'Project'; slug: string; title: string } | null> | null
  prev: Array<{ __typename?: 'Project'; slug: string; title: string } | null> | null
}
...
export type ProjectsQuery = {
  ...
  projects: Array<{
    ...
    thumbnail: {
      ...
      alt: string
      placeholder: string
      source: { __typename?: 'UploadFile'; url: string; width: number | null; height: number | null } | null
    } | null
  } | null> | null
}

export type Projects_ThumbnailsFragment = {
  __typename?: 'Project'
  slug: string
  title: string
  summary: string
...
export type ProjectIdQuery = {
  __typename?: 'Query'
  projects: Array<{ __typename?: 'Project'; id: string } | null> | null
}
...
export type ProjectSlugsQuery = {
  __typename?: 'Query'
  projects: Array<{ __typename?: 'Project'; slug: string } | null> | null
}
 ...
 * });
 */
export function useAwardsQuery(baseOptions?: Apollo.QueryHookOptions<AwardsQuery, AwardsQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<AwardsQuery, AwardsQueryVariables>(AwardsDocument, options)
}
export function useAwardsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AwardsQuery, AwardsQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<AwardsQuery, AwardsQueryVariables>(AwardsDocument, options)
}
...
export type AwardsQueryResult = Apollo.QueryResult<AwardsQuery, AwardsQueryVariables>
 ...
 * __useCareersQuery__
 *
 * To run a query within a React component, call `useCareersQuery` and pass it any options that fit your needs.
 * When your component renders, `useCareersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCareersQuery({
 *   variables: {
 *   },
 * });
 */
export function useCareersQuery(baseOptions?: Apollo.QueryHookOptions<CareersQuery, CareersQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<CareersQuery, CareersQueryVariables>(CareersDocument, options)
}
export function useCareersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CareersQuery, CareersQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<CareersQuery, CareersQueryVariables>(CareersDocument, options)
}
export type CareersQueryHookResult = ReturnType<typeof useCareersQuery>
export type CareersLazyQueryHookResult = ReturnType<typeof useCareersLazyQuery>
export type CareersQueryResult = Apollo.QueryResult<CareersQuery, CareersQueryVariables>
 ...
 * });
 */
export function useIndexPage_MainThumbnailQuery(
  baseOptions?: Apollo.QueryHookOptions<IndexPage_MainThumbnailQuery, IndexPage_MainThumbnailQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<IndexPage_MainThumbnailQuery, IndexPage_MainThumbnailQueryVariables>(
    IndexPage_MainThumbnailDocument,
    options
  )
}
export function useIndexPage_MainThumbnailLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<IndexPage_MainThumbnailQuery, IndexPage_MainThumbnailQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<IndexPage_MainThumbnailQuery, IndexPage_MainThumbnailQueryVariables>(
    IndexPage_MainThumbnailDocument,
    options
  )
}
...
export type IndexPage_MainThumbnailQueryResult = Apollo.QueryResult<
  IndexPage_MainThumbnailQuery,
  IndexPage_MainThumbnailQueryVariables
>
export const OutsourcingsDocument = gql`
  query Outsourcings {
...
/**
 * __useOutsourcingsQuery__
 *
 * To run a query within a React component, call `useOutsourcingsQuery` and pass it any options that fit your needs.
 * When your component renders, `useOutsourcingsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useOutsourcingsQuery({
 *   variables: {
 *   },
 * });
 */
export function useOutsourcingsQuery(
  baseOptions?: Apollo.QueryHookOptions<OutsourcingsQuery, OutsourcingsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<OutsourcingsQuery, OutsourcingsQueryVariables>(OutsourcingsDocument, options)
}
export function useOutsourcingsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<OutsourcingsQuery, OutsourcingsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<OutsourcingsQuery, OutsourcingsQueryVariables>(OutsourcingsDocument, options)
}
export type OutsourcingsQueryHookResult = ReturnType<typeof useOutsourcingsQuery>
export type OutsourcingsLazyQueryHookResult = ReturnType<typeof useOutsourcingsLazyQuery>
export type OutsourcingsQueryResult = Apollo.QueryResult<OutsourcingsQuery, OutsourcingsQueryVariables>
...
export const ProjectMoveDocument = gql`
  query ProjectMove($id: ID!) {
...
/**
 * __useProjectMoveQuery__
 *
 * To run a query within a React component, call `useProjectMoveQuery` and pass it any options that fit your needs.
 * When your component renders, `useProjectMoveQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProjectMoveQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useProjectMoveQuery(baseOptions: Apollo.QueryHookOptions<ProjectMoveQuery, ProjectMoveQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ProjectMoveQuery, ProjectMoveQueryVariables>(ProjectMoveDocument, options)
}
export function useProjectMoveLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProjectMoveQuery, ProjectMoveQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<ProjectMoveQuery, ProjectMoveQueryVariables>(ProjectMoveDocument, options)
}
export type ProjectMoveQueryHookResult = ReturnType<typeof useProjectMoveQuery>
export type ProjectMoveLazyQueryHookResult = ReturnType<typeof useProjectMoveLazyQuery>
export type ProjectMoveQueryResult = Apollo.QueryResult<ProjectMoveQuery, ProjectMoveQueryVariables>
...
export function useProjectSlugsQuery(
  baseOptions?: Apollo.QueryHookOptions<ProjectSlugsQuery, ProjectSlugsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ProjectSlugsQuery, ProjectSlugsQueryVariables>(ProjectSlugsDocument, options)
}
export function useProjectSlugsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProjectSlugsQuery, ProjectSlugsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<ProjectSlugsQuery, ProjectSlugsQueryVariables>(ProjectSlugsDocument, options)
}
export type ProjectSlugsQueryHookResult = ReturnType<typeof useProjectSlugsQuery>
export type ProjectSlugsLazyQueryHookResult = ReturnType<typeof useProjectSlugsLazyQuery>
export type ProjectSlugsQueryResult = Apollo.QueryResult<ProjectSlugsQuery, ProjectSlugsQueryVariables>
...
const result: PossibleTypesResultData = {
  possibleTypes: {
    ...
    ProjectDetailContentDynamicZone: ['ComponentCommonImage', 'ComponentProjectExplanation'],
  },
}
